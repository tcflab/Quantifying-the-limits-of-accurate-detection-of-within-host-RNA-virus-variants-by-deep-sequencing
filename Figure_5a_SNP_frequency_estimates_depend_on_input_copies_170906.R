...
###############################################################################
# Figure 5: Input copy number determines SNP frequency estimation
###############################################################################

#### FIGURE 5A: MEAN AND STANDARD DEVIATION OF SNPS DETECTED >1 TIME - AMPLICON DATASET ##########
...
unique(data_nonunique2$i)
data_nonunique2$i <- factor(data_nonunique2$i, levels=c("246","406","408","424","432","436","470","511","515","540","598","622","635","695"))

data_nonunique2$d <- factor(data_nonunique2$d, levels=c("1e+01","1e+02","1e+03","1e+04",1e+05, 1e+06))
